...
function artcraft_scripts() {
     ...
     * Подключаем стили:
     * Аргументы:
     * 1) название стиля (должен быть уникальным)
     * 2) путь к файлу
     */
    // для локальных стилей
    wp_enqueue_style( 'artcraft-fa', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css' );
    wp_enqueue_style( 'artcraft-ui', 'https://code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css"' );
	...
	wp_enqueue_script( 'artcraft-jquery-ui',  'https://code.jquery.com/ui/1.12.1/jquery-ui.js',  [], '', true );
	wp_enqueue_script( 'artcraft-flex-slider', get_template_directory_uri() . '/js/jquery.flexslider.js', [], '', true );
	wp_enqueue_script( 'artcraft-owl-carousel', get_template_directory_uri() . '/js/owl.carousel.min.js', [], '', true );
	wp_enqueue_script( 'artcraft-owl-fancy-box', get_template_directory_uri() . '/js/jquery.fancybox.js', [], '', true );
